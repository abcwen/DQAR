...
hyperparameters = {
    'halfcheetah-medium-v2':         {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 5, 'num_epochs': 1000, 'gn': 9.0,  'top_k': 1},
    'hopper-medium-v2':              {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 5, 'num_epochs': 1000, 'gn': 9.0,  'top_k': 2},
    'walker2d-medium-v2':            {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 5, 'num_epochs': 1000, 'gn': 1.0,  'top_k': 1},
    'halfcheetah-medium-replay-v2':  {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 5, 'num_epochs': 1000, 'gn': 2.0,  'top_k': 0},
    'hopper-medium-replay-v2':       {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 5, 'num_epochs': 1000, 'gn': 4.0,  'top_k': 2},
    'walker2d-medium-replay-v2':     {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 5, 'num_epochs': 1000, 'gn': 4.0,  'top_k': 1},
    'halfcheetah-medium-expert-v2':  {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 5, 'num_epochs': 1000, 'gn': 7.0,  'top_k': 0},
    'hopper-medium-expert-v2':       {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 5, 'num_epochs': 1000, 'gn': 5.0,  'top_k': 2},
    'walker2d-medium-expert-v2':     {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'no',          'eval_freq': 5, 'num_epochs': 1000, 'gn': 5.0,  'top_k': 1},
    'antmaze-umaze-v0':              {'lr': 3e-4,  'max_q_backup': False,  'reward_tune': 'cql_antmaze', 'eval_freq': 5, 'num_epochs': 1000, 'gn': 2.0,  'top_k': 2},
    'antmaze-umaze-diverse-v0':      {'lr': 3e-4,  'max_q_backup': True,   'reward_tune': 'cql_antmaze', 'eval_freq': 5, 'num_epochs': 1000, 'gn': 3.0,  'top_k': 2},
    'antmaze-medium-play-v0':        {'lr': 1e-3,  'max_q_backup': True,   'reward_tune': 'cql_antmaze', 'eval_freq': 5, 'num_epochs': 1000, 'gn': 2.0,  'top_k': 1},
    'antmaze-medium-diverse-v0':     {'lr': 3e-4,  'max_q_backup': True,   'reward_tune': 'cql_antmaze', 'eval_freq': 5, 'num_epochs': 1000, 'gn': 1.0,  'top_k': 1},
    'antmaze-large-play-v0':         {'lr': 3e-4,  'max_q_backup': True,   'reward_tune': 'cql_antmaze', 'eval_freq': 5, 'num_epochs': 1000, 'gn': 10.0, 'top_k': 2},
    'antmaze-large-diverse-v0':      {'lr': 3e-4,  'max_q_backup': True,   'reward_tune': 'cql_antmaze', 'eval_freq': 5, 'num_epochs': 1000, 'gn': 7.0,  'top_k': 1},
}
...
def train_agent(env, state_dim, action_dim, max_action, device, output_dir, args):
    ...
    evaluations = []
    training_iters = 0
    max_timesteps = args.num_epochs * args.num_steps_per_epoch  # 1e6
    metric = 100.
    ...
    while (training_iters < max_timesteps) and (not early_stop):
        ...
        evaluations.append([eval_res, eval_res_std, eval_norm_res, eval_norm_res_std,
                            ...
                            curr_epoch])
        logger.record_tabular('Time steps:', training_iters)
        logger.record_tabular('D4RL score:', eval_norm_res * 100)
        logger.record_tabular('std_norm_return:', eval_norm_res_std)
        np.save(os.path.join(output_dir, "eval"), evaluations)

        logger.dump_tabular()

        writer.add_scalar("avg_reward", eval_norm_res, global_step=training_iters)
...
if __name__ == "__main__":
    ...
    file_name += f'|{args.seed}|{timestamp}'
    ...
    utils.print_banner(f"Seed: {args.seed}")
